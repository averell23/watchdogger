...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/dog_log.rb", "lib/watchdogger.rb", "lib/watcher", "lib/watcher/base.rb", "lib/watcher/http_watcher.rb", "lib/watcher/log_watcher.rb", "lib/watcher.rb", "lib/watcher_action", "lib/watcher_action/htpost.rb", "lib/watcher_action/kill_process.rb", "lib/watcher_action/log_action.rb", "lib/watcher_action/send_mail.rb", "lib/watcher_action.rb", "lib/watcher_event.rb", "test/http_watcher_test.rb", "test/kill_process_test.rb", "test/log_watcher_test.rb", "test/test_helper.rb", "test/watchdogger_test.rb", "bin/watchdogger", "README.rdoc", "CHANGES", "LICENSE", "sample_config.yml"]
  s.has_rdoc = true
